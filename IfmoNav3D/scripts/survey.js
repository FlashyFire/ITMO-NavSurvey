...
var json = {
    surveyPostId: "47915313-999b-43d1-8819-b68c3f24790f",
    ...
    pages: [
        {
            questions: [
                {
                    type: "html",
                    html: "Приветствую! Вы поможете мне чуточку приблизиться к завершению магистерской диссертации, если пройдёте этот опрос.<br>Прочитайте и выполните задания связанные с нахождением маршрута.<br>Если вы затрудняетесь выполнить задание - нажмите 'Далее'.<br><br>"
                }
            ]
        },
        {
